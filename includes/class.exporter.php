...
if( !class_exists( 'EDD_CSV_Exporter' ) ) {
    ...
    class EDD_CSV_Exporter {
        ...
        public function add_metabox() {
            ...
            //echo '<p><label for="download_files"><input type="checkbox" id="download_files" name="download_files" checked="yes" /> ' . __( 'Include a ZIP of all download files and featured images?', 'edd-csv-manager' ) . '</label></p>';
            echo '<p>';
